...
class LoginAPI(APIView):
    ...
    def post(self, request):
        ...
        if Insertedpassword == password:
            ...
            tokenInsertInDB(record2[0], BITokens + MLTokens)
...
def tokenInsertInDB(uniqueId, value):
    ...
    if check is None:
        ...
        county_unique_id, created_at, bi_token_web, bi_token_mobile, ml_token_web, ml_token_mobile)
        VALUES (%s, %s, %s, %s, %s, %s);'''
	    ...
	    SET  created_at=%s, bi_token_web=%s, bi_token_mobile=%s, ml_token_web=%s, ml_token_mobile=%s
	    WHERE county_unique_id= %s ;
        '''
