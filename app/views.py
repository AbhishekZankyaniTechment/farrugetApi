...
class LoginAPI(APIView):
    ...
    def post(self, request):
        ...
        if Insertedpassword == password:
            ...
            # accessTokenMobileBI = generationAccesstoken(datasetId=datasetIdMobile, reportId=record2[14],
            #                                             groupId=record2[2])
            ...
            # except Exception as e:
            #     pass
            BITokens = GenerateTokens(record2[0], "BI")
            BITokenWeb = BITokens[0]
            BITokenMobile = BITokens[1]
            MLTokens = GenerateTokens(record2[0], "ML")
